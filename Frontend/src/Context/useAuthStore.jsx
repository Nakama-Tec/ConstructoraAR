...
const useAuthStore = create(
  persist( // persist: Middleware que permite almacenar el estado en el almacenamiento local del navegador.
    (set) => ({
      ...
      userName: null, // Estado para el nombre del usuario autenticado.
      ...
      setUserName: (name) => set({ userName: name }), // Función para establecer el nombre del usuario autenticado.
    }),
    {
