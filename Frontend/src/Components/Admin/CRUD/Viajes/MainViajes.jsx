...
import { URL_VIAJES } from '../../../../Constants/endpoints-API';
...
const MainViajes = () => {
    ...
    const columns = [
      ...
      { header: 'Fecha Viaje', accessorKey: 'fechaViaje' },
      {
        header: 'Acciones',
        cell: ({ row }) => (
          <Button onClick={() => console.log("Editar:", row.original.id_viaje)} className='bg-orange-600 text-white px-4 py-2 rounded-full transition duration-200 ease-in-out hover:bg-orange-800 active:bg-orange-900 focus:outline-none"'>
            Editar
          </Button>
        )
      }
