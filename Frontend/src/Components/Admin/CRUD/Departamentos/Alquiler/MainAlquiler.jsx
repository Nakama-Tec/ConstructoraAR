...
const MainAlquiler = () => {
    ...
    const handleEliminarAlquiler = async (alquiler) => {
      ...
      const columns = [
        ...
        { header: 'FechaInicioAlquiler', accessorKey: 'FechaInicioAlquiler' },
        { header: 'FechaFinAlquiler', accessorKey: 'FechaFinAlquiler' },
        { header: 'NombreDepartamento', accessorKey: 'NombreDepartamento' },
        { header: 'DireccionDepartamento', accessorKey: 'DireccionDepartamento' },
        { header: 'DescripcionDepartamento', accessorKey: 'DescripcionDepartamento' },
        ...
        { header: 'TelefonoCliente', accessorKey: 'TelefonoCliente' },
